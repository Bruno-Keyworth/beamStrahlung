...
SIM.crossingAngleBoost = 15.e-3*rad
...
# SIM.action.mapActions['tpc'] = "TPCSDAction"
# SIM.action.mapActions['tpc'] = ('TPCSDAction',{'TPCLowPtStepLimit':True,'TPCLowPtCut':0.001}) # this is from Frank for low pt stuff (keV thresold for lowpt)
SIM.action.mapActions['tpc'] = ('TPCSDAction',{'TPCLowPtStepLimit':True,'TPCLowPtCut':10.0}) # lowpt threshlod -> 10 MeV
...
SIM.filter.filters = {'edep0': {'parameter': {'Cut': 0.0}, 'name': 'EnergyDepositMinimumCut/Cut0'},  \
