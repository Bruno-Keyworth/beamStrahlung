...
SIM.crossingAngleBoost = 15.0e-3 * rad
...
SIM.action.mapActions["tpc"] = (
    "TPCSDAction",
    {"TPCLowPtStepLimit": True, "TPCLowPtCut": 10.0},
)  # lowpt threshlod -> 10 MeV
...
SIM.field.delta_one_step = 0.5e-03 * mm
